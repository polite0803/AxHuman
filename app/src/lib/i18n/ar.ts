...
const messages: TranslationMap = {
  ...
  'onboarding.custom.stepperReadiness': 'الجاهزية',
  ...
  'onboarding.custom.readiness.title': 'فحص الجاهزية النهائي',
  'onboarding.custom.readiness.subtitle': 'لنتأكد من أن مساعدك جاهز للعمل قبل إنهاء الإعداد.',
  'onboarding.custom.readiness.gateHint':
    'تحقّق من وجود اتصال نموذج فعّال للإنهاء — أو اختر التخطي الآن من الأسفل.',
  'onboarding.custom.readiness.skipLabel': 'التخطي الآن — قد لا يعمل مساعدي بعد',
  'onboarding.custom.readiness.finishError': 'تعذّر إتمام الإعداد. يُرجى المحاولة مجددًا.',
  'readiness.runAll': 'إعادة تشغيل الفحوصات',
  'readiness.retry': 'إعادة المحاولة',
  'readiness.checking': 'جارٍ تشغيل الفحوصات…',
  'readiness.loadError': 'تعذّر تشغيل فحوصات الجاهزية. تأكد من تشغيل نواة التطبيق وحاول مجددًا.',
  'readiness.allGood': 'كل شيء يبدو جاهزًا.',
  'readiness.statusOk': 'جاهز',
  'readiness.statusWarn': 'انتباه',
  'readiness.statusFail': 'إجراء مطلوب',
  'readiness.statusSkipped': 'غير منطبق',
