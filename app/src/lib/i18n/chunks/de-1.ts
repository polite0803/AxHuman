...
const de1: TranslationMap = {
  ...
  'settings.ai.openaiOauthDescription': 'Sign in with your ChatGPT account to use OpenAI models without an API key.',
  ...
  'settings.ai.openaiOauthCallbackHint': 'After signing in, paste the full redirect URL from your browser (starts with http://127.0.0.1:1455/).',
  'settings.ai.openaiOauthCallbackPlaceholder': 'http://127.0.0.1:1455/auth/callback?code=...&state=...',
  ...
  'settings.ai.openaiOauthStartError': 'Could not start ChatGPT sign-in. Try again or use an API key.',
  'settings.ai.openaiOauthCompleteError': 'ChatGPT sign-in did not complete. Check the redirect URL and try again.',
  'settings.ai.openaiOauthCallbackRequired': 'Paste the redirect URL from your browser after signing in.',
